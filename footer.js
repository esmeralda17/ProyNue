              ...
              <div class="col-sm-9 col-md-11 col-xl-12">
                <div class="row row-50">
                  <div class="col-md-12 col-lg-12 col-xl-6">
                    <div class="inset-xl-right-20" style="max-width: 510px;"><a class="brand" href="index.html"><img src="/logo-inverse-143x28.png" alt="LOGO" width="143" height="28"/></a>
                      <p>
                      Es una propiedad de 9 hectáreas que consta de *200 lotes
                      unifamiliares campestres desde 300m2.
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3">
                    <p class="h7">Menu Rápido</p>
                    <div class="row" style="max-width: 270px;">
                      <div class="col-6">
                        <ul class="list-marked-variant-2">
                        <li ><a href="index.html">Inicio</a></li>
                        <li ><a href="">Quiénes somos</a></li>
                        <li ><a href="">Plusvalia</a></li>
                        </ul>
                      </div>
                      <div class="col-6">
                        <ul class="list-marked-variant-2">
                        <li ><a href="contactanos.html">Master Plan</a></li>
          ...
          <div class="container text-center">
            <div class="row row-15 flex-md-row-reverse justify-content-md-between align-items-md-center">
              ...
              <div class="col-md-6 text-md-left">
                <p class="rights text-white"><span class="copyright-year"></span><span>&nbsp;&#169;&nbsp;</span><span>El Mezquital.&nbsp; Todos los derechos reservados.</span></a></p>
              </div>
            </div>
          </div>
        </div>
